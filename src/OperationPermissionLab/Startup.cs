...
namespace OperationPermissionLab
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Authorization
            services.AddSingleton<IAuthorizationHandler, OperationPermissionHandler>();
            services.AddSingleton<OperationPermissionRepository, MockOperationPermissionRepository>();
        }
